...
#define  PROBE_RS232_RX_STATE_PAD1                         6u   /* Waiting for padding, first  byte.                    */
#define  PROBE_RS232_RX_STATE_PAD2                         7u   /* Waiting for padding, second byte.                    */
...
#define  PROBE_RS232_TX_STATE_PAD1                         6u   /* Waiting to send padding, first  byte.                */
#define  PROBE_RS232_TX_STATE_PAD2                         7u   /* Waiting to send padding, second byte.                */
