...
*
* Note(s) : (1) If OS_PROBE_USE_FP is defined as 0 in user header file, then the task CPU usages and task
*               stack usages stored in OSProbe_TaskCPUUsage[] and OSProbe_TaskStkUsage[] will be 16-bit
*               integers. This option removes the usage of floating-point types in this code, thereby
*               eliminating the need for a floating-point library.  If OS_PROBE_USE_FP is not defined in
*               user header file, the value defaults to 1.
*********************************************************************************************************
*/

#ifndef  OS_PROBE_USE_FP
#define  OS_PROBE_USE_FP                                   1    /* See Note #1.                                         */
#endif
...
#define  OS_PROBE_N_TASKS                  (OS_MAX_TASKS + OS_N_SYS_TASKS)
...
OS_PROBE_EXT  volatile  FP32      OSProbe_TaskCPUUsage[OS_PROBE_N_TASKS];
OS_PROBE_EXT  volatile  FP32      OSProbe_TaskStkUsage[OS_PROBE_N_TASKS];
#else
OS_PROBE_EXT  volatile  INT16U    OSProbe_TaskCPUUsage[OS_PROBE_N_TASKS];
OS_PROBE_EXT  volatile  INT16U    OSProbe_TaskStkUsage[OS_PROBE_N_TASKS];
#endif
#endif
