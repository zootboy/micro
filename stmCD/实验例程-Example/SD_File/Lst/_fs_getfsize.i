...
#line 13 "FlashFS\\_fs_getfsize.c"
...
U32 __getfsize (IOB *fcb, BOOL set_fidx) {
  ...
  U32 rval; _mutex_acquire(&_stream_list_lock);;

  if (fcb->drive == 4) {
     
    rval = (fcb->fsize); goto end_of_func;;
  }
  if ((fcb->flags & 0x0004) && (set_fidx == 0)) {
