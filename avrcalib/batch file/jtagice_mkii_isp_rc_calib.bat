...
@ECHO ---------------------------------------------------------
"C:\Program Files\Atmel\AVR Tools\JTAGICEmkII\JTAGICEII.exe" -cUSB -I125000 -d ATmega16 -mi -f 0x99e4 -e -pf -if "..\rc_calib.hex"
...
@ECHO ---------------------------------------------------------
"C:\Program Files\Atmel\AVR Tools\JTAGICEmkII\JTAGICEII.exe" -cUSB -d ATmega16 -mi -Y
...
"C:\Program Files\Atmel\AVR Tools\JTAGICEmkII\JTAGICEII.exe" -cUSB -I125000 -d ATmega168 -mi -ae0,0 -ve -ie "0xFF_byte.hex"
...
"C:\Program Files\Atmel\AVR Tools\JTAGICEmkII\JTAGICEII.exe" -cUSB -I125000 -d ATmega168 -mi -e -pf -vf -if"test.hex" -Z0 -Sf0x01FF
