...
@echo off
	...
	@ECHO  oscillator through the JTAG interface with JTAGICE mkII
...
@ECHO ---------------------------------------------------------
"C:\Program Files\Atmel\AVR Tools\JTAGICEmkII\JTAGICEII.exe" -cUSB -d ATmega16 -R -f 0x99e4 -e -pf -if "..\rc_calib.hex"
...
@ECHO ---------------------------------------------------------
"C:\Program Files\Atmel\AVR Tools\JTAGICEmkII\JTAGICEII.exe" -cUSB -d ATmega16 -Y
...
"C:\Program Files\Atmel\AVR Tools\JTAGICEmkII\JTAGICEII.exe" -cUSB -d ATmega16 -R -ae0,0 -ve -ie "0xFF_byte.hex"
...
"C:\Program Files\Atmel\AVR Tools\JTAGICEmkII\JTAGICEII.exe" -cUSB -d ATmega16 -R -e -pf -vf -if"test.hex" -Z0 -Sf0x01FF
