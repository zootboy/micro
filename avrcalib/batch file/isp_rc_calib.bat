...
@echo off
	...
	@ECHO  oscillator through the ISP interface with STK500/AVRISP
...
"C:\Program Files\Atmel\AVR Tools\STK500\stk500.exe" -ccom1 -I57600 -datmega16 -s -f99e4 -e -pf -if"..\rc_calib.hex"
...
@ECHO ---------------------------------------------------------
"C:\Program Files\Atmel\AVR Tools\STK500\stk500.exe" -ccom1 -datmega16 -Y
...
"C:\Program Files\Atmel\AVR Tools\STK500\stk500.exe" -ccom1 -datmega16 -ae0,0 -ve -ie0xFF_byte.hex
...
"C:\Program Files\Atmel\AVR Tools\STK500\stk500.exe" -ccom1 -datmega16 -e -pf -vf -if"test.hex" -Z0 -Sf0x01FF
